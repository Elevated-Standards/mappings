...
**Task ID:** hVXRMWQpQiakGymwADvv8Y  
**Status:** [ ] Not Started  
**Priority:** High  
...
## Description
Build RESTful API endpoints for querying control mappings and relationships

## Objectives
- Implement create mapping query api endpoints functionality
